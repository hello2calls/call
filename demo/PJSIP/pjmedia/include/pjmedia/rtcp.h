...
#define DEFAULT_FEC_SRC_PKTS_CNT  5
...
typedef struct pjmedia_rtcp_stat
{
    ...
    pj_uint32_t rtp_group_pkt_miss_cnt[DEFAULT_FEC_SRC_PKTS_CNT]; /* rtp group miss pkt cnt */
    ...
    pj_uint32_t rtp_pkt_seq_err_cnt;            /* rtp seq err cnt */
    ...
    pj_uint32_t sec_repaired_cnt;
    pj_uint32_t postkid_cur_state;
    pj_uint32_t postkid_single2double_cnt;
    pj_uint32_t postkid_double2single_cnt;
    pj_str_t str_final_postkid;
    char finalPostkid[64];
} pjmedia_rtcp_stat;

/**
 * This structure describes output frame state.
 */
typedef struct pjmedia_output_frame_state
{
    /* Statistic */
    ...
    unsigned int rtp_group_pkt_miss_cnt[DEFAULT_FEC_SRC_PKTS_CNT]; /* rtp group miss pkt cnt */
...
typedef struct pjmedia_rtcp_session
{
    ...
    pjmedia_output_frame_state  output_frame_stat;
