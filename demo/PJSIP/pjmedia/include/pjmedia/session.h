...
/**
 * Get output frame state for the specified stream.
 * See also #pjmedia_session_get_stream_stat_output_frame()
 *
 * @param session	The media session.
 * @param index		Stream index.
 ...
 * @return		PJ_SUCCESS on success.
 */
PJ_DEF(pj_status_t) pjmedia_session_get_stream_stat_output_frame(
					    pjmedia_session *session,
					    unsigned index,
