...
/**
 * This structure contains parameters for sending OPTIONS request, e.g:
 * Account::sendOptionsRequest().
 */
struct SendOptionsRequestParam
{
    /**
     * List of headers etc to be included in outgoing request.
     */
    ...
    /**
     * User data, which will be given back when the result callback is called.
     */
    Token       userData;
...
public:
     ...
     * Default constructor initializes with zero/empty values.
     */
    SendOptionsRequestParam();
};
    
/**
 * This structure contains parameters for sending INFO request, e.g:
 * Account::sendInfoRequest().
 */
struct SendInfoRequestParam
{
    /**
     * List of headers etc to be included in outgoing request.
     */
