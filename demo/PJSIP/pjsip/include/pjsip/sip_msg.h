...
/** INFO method constant. @see pjsip_get_options_method() */
PJ_DECL_DATA(const pjsip_method) pjsip_info_method;
/*
...
/** Get INFO method constant. */
PJ_DECL(const pjsip_method*) pjsip_get_info_method(void);
...
typedef enum pjsip_status_code
{
    ...
    PJSIP_SC_CALLER_NOT_INVITE = 469,
