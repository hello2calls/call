...
typedef struct pjsip_cfg_t
{
    ...
    struct {
         ...
         * If this value is zero, keep-alive will be disabled.
         * The keep-alive transmission will be sent to the registrar's address,
         * after successful registration.
         *
         * Default: 90 (seconds), see PJSIP_TCP_KEEP_ALIVE_INTERVAL
         */
        unsigned tcp_ka_interval_sec;

        /**
         * Specify the data to be transmitted as keep-alive packets.
         *
         * Default: CR-LF-CR-LF, see PJSIP_TCP_KEEP_ALIVE_DATA
         */
        pj_str_t tcp_ka_data;
         ...
         * after successful registration.
         *
         * Default: 10 (seconds), see PJSIP_TCP_KA_TIMEOUT_INTERVAL
         */
        unsigned tcp_ka_timeout_sec;
        
        /**
         * Specify the data to be transmitted as keep-alive packets.
         *
         * Default: CR-LF, see PJSIP_TCP_KA_RESPONSE_DATA
         */
        pj_str_t tcp_ka_response_data;
...
/**
 * Set the timeout to send keep-alive packet for TCP transports.
 * If the value is zero, keep-alive will be timeout at once.
 *
 * Default: 10 (seconds)
 *
 * @see PJSIP_TCP_KA_RESPONSE_DATA
 */
#ifndef PJSIP_TCP_KA_TIMEOUT_INTERVAL
#   define PJSIP_TCP_KA_TIMEOUT_INTERVAL    10
#endif
 ...
 * Default: CRLF
 */
#ifndef PJSIP_TCP_KA_RESPONSE_DATA
#   define PJSIP_TCP_KA_RESPONSE_DATA	    { "\r\n", 2 }
#endif
